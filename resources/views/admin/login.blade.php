    ...
    <form action="/admin/index" method="post">
      @csrf
        ...
        <div class="inputGroup inputGroup1">
          ...
          <input type="email" id="loginEmail" name="email" maxlength="254" placeholder="Example@gmail.com" />
        </div>
        @error('email')
          <small>{{ $message }}</small>
        @enderror
        ...
        <div class="inputGroup inputGroup4">
            <p>Belum punya akun? <a href="/registerAdmin">Register</a></p>
        </div>  
      </form>  
  </div>
